...
// JSON feed มาตรฐาน FEED-SPEC v1.1 — machine-readable ให้ maw blog / CLI / AI อ่านได้
// CORS `*` → oracle ตัวไหนในเครือข่ายก็ fetch อ่านได้
...
interface FeedPost {
  ...
  datetime: string; // ISO 8601 + timezone
...
export const GET: APIRoute = async () => {
  ...
  const posts: FeedPost[] = entries
    ...
    .sort((a, b) => b.timestamp - a.timestamp); // ใหม่สุดก่อน
